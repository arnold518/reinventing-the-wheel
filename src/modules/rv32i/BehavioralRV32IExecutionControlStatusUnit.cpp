...
BehavioralRV32IExecutionControlStatusUnit::BehavioralRV32IExecutionControlStatusUnit(
    std::string name)
...
void BehavioralRV32IExecutionControlStatusUnit::evaluate(size_t current_time,
                                                          Simulator& simulator) {
    const Inputs input{
