...
BehavioralRV32IControlFlowUnit::BehavioralRV32IControlFlowUnit(std::string name)
...
void BehavioralRV32IControlFlowUnit::evaluate(size_t current_time, Simulator& simulator) {
