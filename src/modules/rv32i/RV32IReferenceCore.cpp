...
const ComponentFamily RV32IReferenceCore{
    "rv32i.core.oracle-backed-reference",
    "RV32IReferenceCore",
    nullptr,
    nullptr,
...
void RV32IReferenceCore::attachMemories(std::shared_ptr<Memory64Kx32> instruction_memory,
                                         std::shared_ptr<Memory64Kx32> data_memory) {
...
rv32i::RV32IState RV32IReferenceCore::snapshotState() const {
    return state_;
}
...
void RV32IReferenceCore::publishOutputs(Simulator& simulator, size_t current_time, bool active_core_step) {
